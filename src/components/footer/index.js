        ...
        <div>
            <div className="footer">
                ...
                <div className="footer-elem">
                    ...
                    <hr className="footer-divider"/>
                    <div className="twitter-elem">
                        <span className="twitter-text">@</span>
                        <span className="twitter-username">name </span>
                        <span className="twitter-text">RT @</span>
                        <span className="twitter-username">Donec</span>
                        <span className="twitter-text"> suscipit vehicula turpis sed lutpat Quisque vitae quam neque. </span>
                        <span className="twitter-time">about 9 hours ago</span>
                        <hr className="footer-divider-mini2"/>
                    </div>
                    <div className="twitter-elem">
                        <span className="twitter-text">@</span>
                        <span className="twitter-username">name </span>
